        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center" >
            ...
            <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
              ...
              <div className="grid gap-x-5 gap-y-5 grid-cols-2 ml-5">
                <button className="text-white bg-indigo-500 border-0 py-3 px-8 focus:outline-none hover:bg-green-400 rounded text-lg hover:outline hover:outline-4 hover:outline-green-700">Commentr</button>
                ...
                <button className="text-white bg-indigo-500 border-0 py-3 px-8 focus:outline-none hover:bg-yellow-300 rounded text-lg hover:outline hover:outline-4 hover:outline-yellow-400">Isadisasta</button>
